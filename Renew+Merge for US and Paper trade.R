...
###########	for daily rewnew. summary file exist
	...
	for(i in 1:(length(datetine))){             ####collect old data
		...
		if(length(int)!=1){
			...
			####################UK LO ADJUST#############
			if(Pn=="DU878918"){
				if(as.numeric(summary1[1,coln])>20180830){
					NAVn=NAVn+127404.08352
					NAV=as.character(NAVn)
				}
			}	
			...
			if(Pn=="DU878918"){
				if(as.numeric(summary1[1,coln])>20180830){
					LongNAVn=LongNAVn+127404.08352
				}
			}
...
nop=6
dirb=data.frame(diretion=rep(0,nop),name=rep(0,nop),BM=rep(0,nop),BMI=rep(0,nop))
dirb[1,]=c("/Users/ouyangming/Desktop/DU846825","DU846825","HSI",3391.2184)
dirb[2,]=c("/Users/ouyangming/Desktop/DU846826","DU846826","HSI",3391.2184)
dirb[3,]=c("/Users/ouyangming/Desktop/DU846828","DU846828","AHXA",370.79676)
dirb[4,]=c("/Users/ouyangming/Desktop/DU846829","DU846829","AHXA",370.79676)
dirb[5,]=c("/Users/ouyangming/Desktop/DU846827","DU846827","UKX",9582.89628)
dirb[6,]=c("/Users/ouyangming/Desktop/DU878918","DU878918","UKX",9582.89628)
output = "/Users/ouyangming/Desktop"
renewMERGE(dirb,output)
