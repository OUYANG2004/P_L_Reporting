######merge several account performance into on file#######
...
MERGE <- function(dirb,output){
	...
	for(i in 1:nop){
		...
		summary1 = rbind(dirb[i,2],summary1)
...
nop=4    ########how many account we should merge######
dirb=data.frame(diretion=rep(0,nop),name=rep(0,nop))
dirb[1,]=c("/Users/ouyangming/Desktop/U8293808","U8293808")        #####direction and name######
